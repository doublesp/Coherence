...
public interface SpoonacularApiEndpointInterface {
    ...
    String REQUEST_HEADER_API_KEY = "X-Mashape-Key: C63FSizlZ6mshv49TJt4OapjoeqOp1nSif7jsnz0CoPVIinGat";
    ...
    Observable<List<IngredientV2>> autocompleteIngredient(@Query("query") String keyword, @Query("number") int number);

    @Headers({REQUEST_HEADER_WITH_CACHE, REQUEST_HEADER_API_KEY})
    @GET("recipes/autocomplete")
    Observable<List<RecipeV2>> autocompleteRecipe(@Query("query") String keyword, @Query("number") int number);
}
